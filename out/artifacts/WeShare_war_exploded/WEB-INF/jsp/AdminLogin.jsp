			...
			<div class="container">
				<div class="row">
					<main class="col-md-12">
						<h1 class="page-title">请输入管理员账号和密码</h1>
						
						<article class="post">
							<div class="entry-content clearfix">
								<form action="${pageContext.request.contextPath}/AdminLogin.action" method="post" class="contact-form">
									<div class="row">
										<div class="col-md-6 col-md-offset-3">
											<input type="text" name="admin_name" placeholder="账号" required>
                    ...
                    <div class="entry-content clearfix">
                        ...
                        <div class="read-more cl-effect-14">
                            <a href="toLogin.action" class="more-link">进入<span class="meta-nav">→</span></a>
                        </div>
                    </div>
                </article>
